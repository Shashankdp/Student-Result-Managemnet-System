...
public class insertnewresult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_management_system/icons8-checklist-30.png"))); // NOI18N
        ...
        jButton6.setFont(new java.awt.Font("Gill Sans MT", 1, 18)); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String html=jTextField2.getText();
        String css=jTextField3.getText();
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("select * from student where rollno='"+rollno+"'"); // here
            
            if(rs.next()){// if rollnumber is present in student db
                st.executeUpdate("insert into result(rollno,html,css,java,dbms) values('"+rollno+"','"+html+"','"+css+"','"+java+"','"+dbms+"')");
...
//              
//              Statement st = con.createStatement();
//              st.executeUpdate("insert into Result values('"+rollno+"','"+html+"','"+css+"','"+java+"','"+dbms+"')");
